...
class ProductManager{
    ...
    constructor(){
        this.#products = []
        this.path= "components/productos.json"
    }
 ...
 let main= async()=>{
    try{ 
       ...
       /*  console.log(await  productosNuevos.getProducts())
        ...
        console.log(await productosNuevos.addProduct("Hexagonal transicional 0.1", "20 por 20 cms, enmarcadas", 35000, "https://firebasestorage.googleapis.com/v0/b/ecommerceart-fb0d5.appspot.com/o/2021-4.jpg?alt=media&token=c5570257-81f9-4f03-bcc6-c8b75f4e5ee4","jkl122", 4))
        console.log( await productosNuevos.addProduct("Warm magical tropical oceans", "100 por 140 cms",200000 ,"https://firebasestorage.googleapis.com/v0/b/ecommerceart-fb0d5.appspot.com/o/2017-4.jpg?alt=media&token=83af4b88-ad01-4a09-8f19-f8c82be9e2d1", "jkl123", 1))
        console.log( await productosNuevos.addProduct("S/t", "120 por 80 cms",165000 ,"https://firebasestorage.googleapis.com/v0/b/ecommerceart-fb0d5.appspot.com/o/2020-1.jpg?alt=media&token=97a6bba7-ef61-4c87-98ab-1430979cf2f5", "jkl124", 2))
        console.log( await productosNuevos.addProduct("Complementario", "120 por 80 cms",165000 ,"https://firebasestorage.googleapis.com/v0/b/ecommerceart-fb0d5.appspot.com/o/GF-2628copia.jpg?alt=media&token=d275a8f6-3466-4414-be83-6e01840727c4","jkl125",4 ))
        console.log( await productosNuevos.addProduct("Neobarroco", "140 por 100 cms",200000 ,"https://firebasestorage.googleapis.com/v0/b/ecommerceart-fb0d5.appspot.com/o/2019-2.jpg?alt=media&token=ffe5c232-a20b-4976-a5a8-9618e04c295c", "jkl126", 3))
        console.log( await productosNuevos.addProduct("S/T", "70 por 70 cms", 84000,"https://firebasestorage.googleapis.com/v0/b/ecommerceart-fb0d5.appspot.com/o/2018-1.jpg?alt=media&token=5f10af30-4f9a-43d3-b396-0d8406781f4e", "jkl127", 2))
        console.log( await productosNuevos.addProduct("Generativo fractal", "100  por 100 cms", 171800,"https://firebasestorage.googleapis.com/v0/b/ecommerceart-fb0d5.appspot.com/o/2022-1.jpg?alt=media&token=0052f005-41ba-4f95-9649-025206272012", "jkl128", 3))
        console.log( await productosNuevos.addProduct("Metamorfosis Hexagonal 0.1, 0.2 y 0.3", "20 por 20 cms cada una, enmarcadas", 35000,"https://firebasestorage.googleapis.com/v0/b/ecommerceart-fb0d5.appspot.com/o/2021-3.jpg?alt=media&token=df21dfa5-db48-4987-9605-ae4761fb06a6", "jkl129", 8))
        console.log( await productosNuevos.addProduct("S/T", "50 por 50 cms", 45000,"https://firebasestorage.googleapis.com/v0/b/ecommerceart-fb0d5.appspot.com/o/2016-1.jpg?alt=media&token=68e3ca1c-1b8e-4817-a7c1-3bd0bb0edd83", "jkl130", 1))
        console.log( await productosNuevos.addProduct("Generativo Hexagonal Magenta", "100 por 100 cms", 171800,"https://firebasestorage.googleapis.com/v0/b/ecommerceart-fb0d5.appspot.com/o/GF-2623-copia.jpg?alt=media&token=8730f87d-4233-4729-9aaf-fca4a9368617", "jkl131", 3))
        console.log( await productosNuevos.addProduct("Generativo Hegagonal", "120 por 80 cms",165000 ,"https://firebasestorage.googleapis.com/v0/b/ecommerceart-fb0d5.appspot.com/o/2021-2.jpg?alt=media&token=a46429c6-28b6-4ca3-ad37-281a3da3d28b", "jkl132", 2))
